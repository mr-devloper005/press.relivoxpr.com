...
const buttonClass = 'inline-flex h-[3.25rem] items-center justify-center border border-black bg-[var(--slot4-accent)] px-6 text-xs font-black uppercase tracking-[0.2em] text-white transition hover:bg-[var(--slot4-deep)] disabled:opacity-60'
